...
To use these stylesheets, rename the files and drupal_sgf with the name of your theme.
...
drupal_sgf-alpha-default-narrow.css  
...
drupal_sgf-alpha-default-normal.css
...
drupal_sgf-alpha-default-wide.css
