...
To use these stylesheets, rename the files and sgf_theme with the name of your theme.
...
sgf_theme-alpha-default-narrow.css  
...
sgf_theme-alpha-default-normal.css
...
sgf_theme-alpha-default-wide.css
